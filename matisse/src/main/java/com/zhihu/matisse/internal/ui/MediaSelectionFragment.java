...
import static com.zhihu.matisse.ui.MatisseActivity.STYLETYPE;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public static MediaSelectionFragment newInstance(Album album,int styleType) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        int styleType = getArguments().getInt(STYLETYPE, 0);
        mAdapter = new AlbumMediaAdapter(getContext(),
                mSelectionProvider.provideSelectedItemCollection(), mRecyclerView, styleType);
