...
public class AlbumMediaAdapter extends
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView,int StyleType) {
        super(null);
...
//            captureViewHolder.mHint.setCompoundDrawables(drawables[0], drawables[1], drawables[2], drawables[3]);
            ...
            if (StyleType == SINGLECHOICE || StyleType == GALLERYCHOICE) {
                mediaViewHolder.mMediaGrid.setCheckVisible(View.GONE);
            }
        }
